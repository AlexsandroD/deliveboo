...
@section('content')
            ...
            <div class="col-lg-6">
                ...
                <div class="dish-info">
                    ...
                    <div class="btn-container text-right mt-4">
                        {{-- edit button --}}
                        <a href="{{ route('dishes.edit', $dish->id) }}" class="ml-3"><button type="button"
                                class="btn btn_border">Modifica</button></a>
                        {{-- modal delete button --}}
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        {{-- delete form --}}
                                        <form action="{{ route('dishes.destroy', $restaurant->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
    ...
    {{-- aside lg --}}
    <aside class="col-lg-3 pl-0 aside dish">
