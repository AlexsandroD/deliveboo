    ...
    @if (!$restaurant)
        ...
        <div class="col-lg-9 restaurant">
            ...
            <div id="restaurantless-add">
                <a href="{{ route('restaurants.create') }}"><button type="button" class="btn"><i
                            class="fa-solid fa-circle-plus"></i></button></a>
            </div>
        </div>
    @else
            ...
            <div class="row no-gutters card_header">
                ...
                <div class="col-md-5">
                    @if ($restaurant->image_cover)
                        <img class="restaurant-cover" src="{{ asset('storage/' . $restaurant->image_cover) }}"
                            alt="{{ $restaurant->name }}">
                    @else
                        <img class="restaurant-cover" src="{{ asset('/images/placeholder.svg') }}"
                            alt="{{ $restaurant->name }}">
                    @endif
                </div>

                {{-- restaurant info --}}
                <div class="col-md-7 restaurant-info">
                ...
                <div class="col card-body">
                    ...
                    <ul class="contacts-container">
                        ...
                        <li class="card-text">
                            ...
                            {{ $restaurant->address }}, {{ $restaurant->city }} {{ $restaurant->post_code }},
                            {{ $restaurant->country }}
                        </li>
                        <li class="card-text">
                    ...
                    <div class="btn-container text-right">
                        {{-- edit button --}}
                        <a href="{{ route('restaurants.edit', $restaurant->id) }}" class="ml-3"><button
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Sei sicuro di voler eliminare
                                            <strong>{{ $restaurant->name }}</strong>?</h5>
